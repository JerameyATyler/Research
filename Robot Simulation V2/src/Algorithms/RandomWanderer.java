 ...
 * perform one of three movements. It may move on unit forward. It may rotate 45
 * degrees counter clockwise. Or it may rotate 45 degrees counterclockwise. Used
 * as a baseline to compare other navigation algorithms against.
 *
...
public class RandomWanderer extends NavigationLibrary
{
    ...
    /**
     * Constructor for RandomWanderer algorithm. Accepts a list of parameters
     * and the environment map as input.
     *
     * @param params   A parameter object that will contain th experiment
     *                 parameters
